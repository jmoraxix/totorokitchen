...
export class TipoComidas extends Component {
  state = {
    data: [],
    dataLoaded: false
  };
  ...
  async listarObjetos() {
    await TipoComidaDataService.getAll()
      .then(response => {
        this.setState({
          data: response.data,
          dataLoaded: true
  ...
  eliminarObjeto(_id){
    TipoComidaDataService.delete(_id)
        .then(response => {
          console.log(response.data);
          this.listarObjetos();
        })
  ...
  render() {
    return (
      <>
        ...
        <br />
         <Row>
           <Col><h1>Tipos de Comidas</h1></Col>
...
export function TipoComida() {
  ...
  function handleSubmit(e) {
    ...
    e.preventDefault();
    if(isNew){
      TipoComidaDataService.create(objeto)
        .then(response => {
        })
        .catch(e => {
          console.log(e);
      ...
      TipoComidaDataService.update(objeto._id, objeto)
        .then(response => {
        })
        .catch(e => {
          console.log(e);
