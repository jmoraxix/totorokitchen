...
export class Productos extends Component {
  ...
  async listarObjetos() {
    await ProductoDataService.getAll()
      .then(response => {
        this.setState({
          data: response.data,
          dataLoaded: true
  ...
  eliminarObjeto(Consecutivo){
    ProductoDataService.delete(Consecutivo)
        .then(response => {
          console.log(response.data);
          this.listarObjetos();
        })
...
export function Producto() {
  ...
  function handleSubmit(e) {
    ...
    e.preventDefault();
    if(isNew){
      ProductoDataService.create(objeto)
        .then(response => {
        })
        .catch(e => {
          console.log(e);
      ...
      ProductoDataService.update(objeto._id, objeto)
        .then(response => {
        })
        .catch(e => {
          console.log(e);
      ...
      <form onSubmit={handleSubmit}>
        { cargaObjeto &&
            <div>
              ...
              <div className="form-group row">
                <label htmlFor="producto" className="col-4 col-form-label">Tipo</label>
                <div className="col-8">
                  <input name="producto" type="text" className="form-control" required="required" value={objeto.producto} onChange={handleChange}/>
                </div>
              </div>
              <div className="form-group row">
