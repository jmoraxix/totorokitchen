...
export class Empleados extends Component {
  ...
  async listarObjetos() {
    await EmpleadoDataService.getAll()
      .then(response => {
        this.setState({
          data: response.data,
          dataLoaded: true
  ...
  eliminarObjeto(Consecutivo){
    EmpleadoDataService.delete(Consecutivo)
        .then(response => {
          console.log(response.data);
          this.listarObjetos();
        })
...
export function Empleado() {
  ...
  function handleSubmit(e) {
    ...
    e.preventDefault();
    if(isNew){
      EmpleadoDataService.create(objeto)
        .then(response => {
        })
        .catch(e => {
          console.log(e);
      ...
      EmpleadoDataService.update(objeto._id, objeto)
        .then(response => {
        })
        .catch(e => {
          console.log(e);
      ...
      <form onSubmit={handleSubmit}>
        { cargaObjeto &&
            <div>
              ...
              <div className="form-group row">
                <label htmlFor="empleado" className="col-4 col-form-label">Tipo</label>
                <div className="col-8">
                  <input name="empleado" type="text" className="form-control" required="required" value={objeto.empleado} onChange={handleChange}/>
                </div>
              </div>
              <div className="form-group row">
